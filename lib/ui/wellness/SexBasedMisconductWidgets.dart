...
class WellnessSexBasedMisconductHomeWidget extends StatefulWidget {
  final ScrollController scrollController;

  WellnessSexBasedMisconductHomeWidget(this.scrollController);

  @override
  State<WellnessSexBasedMisconductHomeWidget> createState() => _WellnessSexBasedMisconductHomeWidgetState();
}

class _WellnessSexBasedMisconductHomeWidgetState extends State<WellnessSexBasedMisconductHomeWidget> implements NotificationsListener {
  ...
  void _onTapTakeScreener() {
    Navigator.push(context, CupertinoPageRoute(builder: (context) =>
      SurveyPanel(
        ...
        analyticsFeature: AnalyticsFeature.WellnessSexBasedMisconduct,
      )
    ));
  }
